...
namespace TestFile
{
    ...
    public class JsonTest : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            string myJsonString = "[\"Cane \", [1, 2, 3]]";

            List<object>  parsedRoot = (List<object>)Json.Deserialize(myJsonString);
            string animal = parsedRoot[0].ToString();
            ...
            string myJsonString2 = "{\"Cane\" : [1, 2, 3], \"Gatto\" : [4, 5, 6]}";
            ...
            foreach (KeyValuePair<string, object> pair in parsedRoot2)
            {
                ...
                //Debug.Log(animal2_strength);
                //Debug.Log(animal2_dexterity);
                //Debug.Log(animal2_intelligence);
            }
            ...
            for(int i = 0; i < 4; i++)
            {
                ...
                // Create and serializable representation
                ...
                foreach (var equip in saveData.equipment)
                {
                    equipmentJson.Add(equip);
                }
            ...
            System.IO.File.WriteAllText(Application.persistentDataPath + "/allSaves.json", allSaveDataJson);
            ...
            string[] saveFilesNames = Directory.GetFiles(Application.persistentDataPath + "/SaveData");
            foreach (string fileName in saveFilesNames)
            {
